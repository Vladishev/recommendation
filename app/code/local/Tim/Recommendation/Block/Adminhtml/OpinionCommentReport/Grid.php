...
class Tim_Recommendation_Block_Adminhtml_OpinionCommentReport_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        /*$collection->getSelect()->join(array('cpev' => 'catalog_product_entity_varchar'), "main_table.product_id = cpev.entity_id
        AND cpev.entity_type_id = (
        ...
        ", array('value'));
        $collection->getSelect()->joinLeft(array('cpemg' => 'catalog_product_entity_media_gallery'), "cpemg.entity_id = main_table.product_id
        AND cpemg.attribute_id = (
            SELECT ea.attribute_id
            FROM eav_attribute ea
            JOIN eav_entity_type eat
            ON ea.entity_type_id = eat.entity_type_id
            AND eat.entity_type_code = 'catalog_product'
            AND ea.attribute_code = 'media_gallery')",
        array('images' => 'IF (cpemg.value_id, "YES", "NO")'));*/
